...
# =============================================================================
# Crea il venv Python su /workspace/.venv (persiste tra i pod).
# Se il venv esiste già e il marker setup_complete è presente, salta
# l'intera installazione delle dipendenze (~20 min risparmiati).
#
# Usage:
...
# ── 3 & 4. Installa dipendenze (solo se non già fatto) ────────────
if [ -f "$MARKER" ]; then
    echo ""
    echo "[3/5] PyTorch — già installato, skip."
    echo "[4/5] Dipendenze — già installate, skip."
else
